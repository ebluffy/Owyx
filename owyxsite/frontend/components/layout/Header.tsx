...
/**
 * Header: main nav/actions stay in the max-w-6xl content column.
 * Lang + theme sit on the viewport right edge so they don’t push
 * Download / Profile leftward.
 */
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-line/60 bg-bg/55 backdrop-blur-xl liquid-glass-header">
      <div className="relative flex h-16 w-full items-center">
        {/* Edge chrome — outside the content column (viewport right). */}
        <div className="pointer-events-none absolute inset-y-0 right-0 z-20 flex items-center gap-2 pr-3 sm:pr-4">
        ...
        {/* Main column — same width as page body / footer. */}
        <div className="mx-auto flex h-full w-full max-w-6xl items-center justify-between gap-3 px-4 sm:px-6 pr-[7.75rem] sm:pr-[9.25rem]">
